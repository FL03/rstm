...
impl<Q, A> AsRef<[Rule<Q, A>]> for ProgramO<Q, A>
where
    Q: RawState,
{
...
impl<Q, A> AsMut<[Rule<Q, A>]> for ProgramO<Q, A>
where
    Q: RawState,
{
...
impl<Q, A> core::ops::Deref for ProgramO<Q, A>
where
    Q: RawState,
{
...
impl<Q, A> core::ops::DerefMut for ProgramO<Q, A>
where
    Q: RawState,
{
...
impl<Q, A> core::ops::Index<Head<Q, A>> for ProgramO<Q, A>
where
...
impl<Q, A> From<Vec<Rule<Q, A>>> for ProgramO<Q, A>
where
    Q: RawState + Default,
{
...
impl<Q, A> Extend<Rule<Q, A>> for ProgramO<Q, A>
where
    Q: RawState,
{
...
impl<Q, A> Extend<(Head<Q, A>, Tail<Q, A>)> for ProgramO<Q, A>
where
    Q: RawState,
{
...
impl<Q, A> FromIterator<Rule<Q, A>> for ProgramO<Q, A>
where
    Q: RawState + Default,
{
...
impl<Q, A> FromIterator<(Head<Q, A>, Tail<Q, A>)> for ProgramO<Q, A>
where
    Q: RawState + Default,
{
...
impl<Q, A> IntoIterator for ProgramO<Q, A>
where
    Q: RawState,
{
    type Item = Rule<Q, A>;
